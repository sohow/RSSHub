({ "81.cn":{ _name:"中国军网",
  ...
  "beijing.gov.cn":{ _name:"上海市人民政府",
    "yewu.ghzrzyw":[ { title:"北京土地拍卖信息",
        docs:"https://docs.rsshub.app/routes/government",
        source:[ "/gwxxfb/tdsc/:tab.html",
          "//yewu.ghzrzyw.beijing.gov.cn/gwxxfb/tdsc/:tab.html" ],
        target:"/gov/beijing/land/:tab/:filter?/:limit?" } ],
    jw:[ { title:"通知公告",
        docs:"https://docs.rsshub.app/routes/government",
        source:[ "/tzgg" ],
        target:"/gov/beijing/jw/tzgg" } ],
    "bjjs.zjw":[ { title:"北京市住建委新建商品房预售许可公示",
        docs:"https://docs.rsshub.app/routes/government",
        source:[ "/eportal/ui?pageId=307670&isTrue=1" ],
        target:"/gov/beijing/zjwxk/:ddlYT?/:ddlQX?/:rblFWType1?" } ] },
  ...
  "lianjia.com":{ _name:"链家",
    ".":[ { title:"链家",
        docs:"https://docs.rsshub.app/routes/other",
        source:[ "/zufang" ],
        target:"/lianjia/:city?/:type?/:query?" } ] },
  "lianxh.cn":{ _name:"连享会",
    www:[ { title:"精彩资讯",
        docs:"https://docs.rsshub.app/routes/programming",
